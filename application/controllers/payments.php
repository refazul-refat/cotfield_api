	...
	public function index(){
		...
		if($request_type=='POST'){
			if($payment_id==0){
				...
				$payment->notification=$this->input->post('payment_notification');
				$payment->lc_maturity_notification=$this->input->post('payment_lc_maturity_notification');
				...
				if($this->input->post('method')=='update'){
					$payment=new stdClass;
					if($this->input->post('payment_notification'))$payment->notification=$this->input->post('payment_notification');
					if($this->input->post('payment_lc_maturity_notification'))$payment->lc_maturity_notification=$this->input->post('payment_lc_maturity_notification');
